...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      tertiary: Color(4286666002),
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4294958518),
      ...
      tertiaryFixed: Color(4294958518),
      onTertiaryFixed: Color(4280948736),
      tertiaryFixedDim: Color(4294425712),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryFixedDim: Color(4286468879),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      tertiary: Color(4294425712),
      onTertiary: Color(4282788352),
      tertiaryContainer: Color(4284759808),
      onTertiaryContainer: Color(4294958518),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiary: Color(4294688884),
      onTertiary: Color(4280488704),
      tertiaryContainer: Color(4290479937),
      ...
      tertiaryFixedDim: Color(4294425712),
      onTertiaryFixedVariant: Color(4283314176),
      surfaceDim: Color(4279309080),
      surfaceBright: Color(4281809214),
      surfaceContainerLowest: Color(4278980115),
      surfaceContainerLow: Color(4279835680),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryContainer: Color(4294688884),
      onTertiaryContainer: Color(4278190080),
      ...
      tertiaryFixedDim: Color(4294688884),
