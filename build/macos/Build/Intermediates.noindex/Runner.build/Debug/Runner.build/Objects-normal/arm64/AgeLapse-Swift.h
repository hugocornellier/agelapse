...
#ifndef AGELAPSE_SWIFT_H
#define AGELAPSE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AgeLapse",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8AgeLapse11AppDelegate")
...
SWIFT_CLASS("_TtC8AgeLapse17MainFlutterWindow")
