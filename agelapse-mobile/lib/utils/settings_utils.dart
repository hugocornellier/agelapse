...
class SettingsUtil {
  ...
  static Future<bool> loadFramerateIsDefault(String projectId) async {
    try {
      String settingValueStr = await DB.instance.getSettingValueByTitle('framerate_is_default', projectId);
  ...
  static Future<bool> loadEnableGrid() async {
    try {
      String enableGridValueStr = await DB.instance.getSettingValueByTitle('enable_grid');
  ...
  static Future<bool> loadWatermarkSetting(String projectId) async {
    try {
      String settingValueStr = await DB.instance.getSettingValueByTitle('enable_watermark', projectId);
  ...
  static Future<bool> loadNotificationSetting() async {
    try {
      String settingValueStr = await DB.instance.getSettingValueByTitle('enable_notifications');
      return bool.tryParse(settingValueStr) ?? true;
    } catch (e) {
      return true;
    }
  ...
  static Future<String> loadWatermarkPosition() async {
    try {
      return Utils.capitalizeFirstLetter(await DB.instance.getSettingValueByTitle('watermark_position'));
    } catch (e) {
  ...
  static Future<String> _loadOffsetCurrentOrientation(String projectId, String axis) async {
    final String activeProjectOrientation = await loadProjectOrientation(projectId);
  ...
  static Future<String> loadGuideOffsetXCurrentOrientation(String projectId) async {
    return await _loadGuideOffsetCurrentOrientation(projectId, 'X');
  }

  static Future<String> loadGuideOffsetYCurrentOrientation(String projectId) async {
    return await _loadGuideOffsetCurrentOrientation(projectId, 'Y');
  }

  static Future<String> _loadGuideOffsetCurrentOrientation(String projectId, String axis) async {
    final String activeProjectOrientation = await loadProjectOrientation(projectId);
    final String offsetColName = (activeProjectOrientation == 'landscape')
  ...
  static Future<void> setHasOpenedNonEmptyGalleryToTrue(String projectIdStr) async {
  ...
  static Future<void> setGridModeIndex(String projectId, int gridModeIndex) async {
    await DB.instance.setSettingByTitle(
      'grid_mode_index',
