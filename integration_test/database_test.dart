  ...
  group('DatabaseHelper Integration Tests', () {
    ...
    group('Photos CRUD', () {
      ...
      testWidgets('doesPhotoExistByTimestamp works correctly', (tester) async {
        ...
        final exists = await DB.instance.doesPhotoExistByTimestamp(
          '1111111111',
          projectId,
        );
        final notExists = await DB.instance.doesPhotoExistByTimestamp(
          '9999999999',
          projectId,
        );
      ...
      testWidgets('getPhotosByProjectIDNewestFirst returns sorted photos', (
        ...
        final photos = await DB.instance.getPhotosByProjectIDNewestFirst(
          projectId,
        );
      ...
      testWidgets(
        'getEarliestPhotoTimestamp and getLatestPhotoTimestamp work',
        (tester) async {
          app.main();
          await tester.pumpAndSettle(const Duration(seconds: 2));
      ...
      testWidgets('face embedding storage and retrieval works', (tester) async {
        ...
        final stored = await DB.instance.getPhotoEmbedding(
          '9999999999',
          projectId,
        );
    ...
    group('Videos CRUD', () {
      testWidgets('addVideo creates a new video record', (tester) async {
        ...
        final id = await DB.instance.addVideo(
          projectId,
          '1080p',
          'true',
          'lower left',
