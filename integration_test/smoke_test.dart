  ...
  group(
    ...
    () {
      testWidgets('app launches and shows initial screen', (tester) async {
        ...
        final hasApp =
            materialAppFinder.evaluate().isNotEmpty ||
      ...
      testWidgets('main navigation loads with existing project', (
        tester,
      ) async {
        ...
        final hasCollectionsIcon = find
            .byIcon(Icons.collections)
            .evaluate()
            .isNotEmpty;
        final hasCameraIcon = find
            .byIcon(Icons.camera_alt)
            .evaluate()
            .isNotEmpty;
        final hasPlayIcon = find
            .byIcon(Icons.play_circle)
            .evaluate()
            .isNotEmpty;
