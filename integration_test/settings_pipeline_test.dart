...
void main() {
  ...
  group('Settings Pipeline Integration Tests', () {
    ...
    testWidgets(
      'Test B: framerate setting is read from DB during compilation',
      (tester) async {
        app.main();
        await tester.pump(const Duration(seconds: 2));
        ...
        final newestVideo2 = await DB.instance.getNewestVideoByProjectId(
          testProjectId!,
        );
        expect(newestVideo2, isNotNull);
        expect(
          newestVideo2!['framerate'],
          10,
    ...
    testWidgets('Test C: video_resolution setting is used during compilation', (
      ...
      expect(
        await File(videoPath1080).exists(),
        isTrue,
        reason: '1080p video output file should exist',
      );
      expect(
        await File(videoPath1080).length(),
        greaterThan(100),
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final hevcAvailable = VideoCodec.availableCodecs(
        ...
        expect(
          codecA,
          VideoCodec.h264,
          reason: 'Project A codec should be h264',
        );
        expect(
          loadedCodecB,
          codecB,
          reason: 'Project B codec should be $codecB',
        );
    ...
    testWidgets(
      'Test E: solid background setting produces valid H.264 output',
      (tester) async {
        app.main();
        await tester.pump(const Duration(seconds: 2));
        ...
        await DB.instance.setSettingByTitle(
          'video_background',
          VideoBackground.solidColor('#000000').toDbValue(),
          pid,
        );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          success,
          isTrue,
          reason: 'ProRes 422 compilation should succeed',
        );
